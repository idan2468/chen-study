...
export const he = {
  common: {
    ...
    flipHintTap: "הקשה להיפוך הכרטיסייה",
  ...
  unseen: {
    ...
    readingHintTap:
      "💡 הקשה על מילה תשמיע אותה • הקשה כפולה תסמן אותה בצבע • מילים מודגשות מופיעות גם בכרטיסיות",
    usageHint:
      "חדשים כאן? מומלץ להתחיל בכרטיסיות המילים כדי ללמוד את המילים החשובות, ואז לעבור לקריאה ושאלות.",
